...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, config, document;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.use('/docs', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            return [2 /*return*/, basicAuth({
                                    users: (_a = {},
                                        _a["".concat(configService.get('docs.userName'))] = "".concat(configService.get('docs.password')),
                                        _a),
                                    challenge: true
                                })(req, res, next)];
                        });
